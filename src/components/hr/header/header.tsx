            ...
            html: `
                <div class="${classes.employeeDetails}">
                      ...
                      <div class="${classes.formGroup}">
                        ...
                        <img  src="${`data:image/jpeg;base64,${response.data.data!.image!}`}" alt=''
                                    width="100" height="100"/>
                    </div>
                    <div class="${classes.formGroup}"></div>
                    <div class="${classes.formGroup}">
                        <label><strong>Mã nhân viên:</strong></label>
                        <input type="text" value="${response.data.data!.idEmployee}" readonly class="${classes.input}"/>
                    </div>
                    <div class="${classes.formGroup}">
                        <label><strong>Họ:</strong></label>
                        <input type="text" value="${response.data.data!.firstName}" readonly class="${classes.input}"/>
                    </div>
                    <div class="${classes.formGroup}">
                        <label><strong>Tên:</strong></label>
                        <input type="text" value="${response.data.data!.lastName}" readonly class="${classes.input}"/>
                    </div>
                    <div class="${classes.formGroup}">
                        <label><strong>Giới tính:</strong></label>
                        <input type="text" value="${response.data.data!.gender}" readonly class="${classes.input}"/>
                    </div>
                    <div class="${classes.formGroup}">
                        <label><strong>Ngày sinh:</strong></label>
                        <input type="text" value="${response.data.data!.birthDate}" readonly class="${classes.input}"/>
                    </div>
                    <div class="${classes.formGroup}">
                        <label><strong>Địa chỉ:</strong></label>
                        <input type="text" value="${response.data.data!.address}" readonly class="${classes.input}"/>
                    </div>
                    <div class="${classes.formGroup}">
                        <label><strong>Số điện thoại:</strong></label>
                        <input type="text" value="${response.data.data!.phoneNumber}" readonly class="${classes.input}"/>
                    </div>
                    <div class="${classes.formGroup}">
                        <label><strong>CMND:</strong></label>
                        <input type="text" value="${response.data.data!.idCard}" readonly class="${classes.input}"/>
                    </div>
                    <div class="${classes.formGroup}">
                        <label><strong>Email:</strong></label>
                        <input type="text" value="${response.data.data!.email}" readonly class="${classes.input}"/>
                    </div>
                     <div class="${classes.formGroup}">
                        <label><strong>Phòng ban:</strong></label>
                        <input type="text" value="${response.data.data!.department}" readonly class="${classes.input}"/>
                    </div>
                     <div class="${classes.formGroup}">
                        <label><strong>Chức vụ:</strong></label>
                        <input type="text" value="${response.data.data!.position}" readonly class="${classes.input}"/>
                    </div>
                    <div class="${classes.formGroupPair}">
                        <div class="${classes.formGroup}">
                            <label><strong>Bằng cấp:</strong></label>
                            <input type="text" value="${response.data.data!.degree}" readonly class="${classes.input}"/>
                        </div>
                        <div class="${classes.formGroup}">
                            <label><strong>Trạng thái:</strong></label>
                            <input type="text" value="${response.data.data!.status}" readonly class="${classes.input}"/>
                        </div>
                    </div>
                </div>
            `,
