...
export default function HR_RewardPunishPage(){
    ...
    const currentData = searchTerm !== '' ? rewardPunish.filter(
        (item) =>
        ...
        <div className={classes.article}>
             <h2 style={{textAlign:"center"}}>Quản lý thưởng phạt</h2>
                ...
                <div className={classes.groupOption}>
                    ...
                    />
                  <button className={classes.btnAddRole}  onClick={showFormAdd}><FontAwesomeIcon icon={faPlus} 
